...
const Signup = () => {
  return (
    ...
    <div className="form-group">
        <input className="p-2" type="password" id="inputPassword" placeholder="Password"/> <br />
        <input className="p-2" type="password" id="inputPassword" placeholder="Confirm Password"/>
    </div>
